...
1. Open in a new tab https://github.com/janmaghuyop/thesis-team-members
...
```
cd ~/Downloads
git clone git@github.com:username/thesis-team-members.git
cd thesis-team-members
```

## 3. Set upstream URL
Open the terminal, copy and paste the command(s) below and hit enter.
```
git remote add upstream git@github.com:janmaghuyop/thesis-team-members.git
```
